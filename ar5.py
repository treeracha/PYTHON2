...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EuMxx4uvJs5aOrl25Aod.shyzkohN5EqZUaaBNnCr+q.10AD8fnHF3X3BQieN1IDykCcLd0qTut/blRx7CG4uKs=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EukiErNRUxZWheRcDDN4.WZHor24qG0o86s+hz/W6ja.xsXQFq7Sqdi/3x5aKsvxXLA/nwStGRoqmrlvjwiPhMU=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='Eu2cZkXYGluNfpZ3FWza.pF7mlbAaP9yzvvtWTIGgYG.iAJO3wExQj68FrG0cz1AnXdt+9dmUVniSRyBoBP+Pz0=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='Eu4oB61EvpY1SVjY9w8f.vu5K8qAkuvGN3TdERzz0hW.Fx0IO+skxzIfSyHpaWNYahvz95crB00cWQ3qfLAhHxA=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EuVCWkYsPJiPOgc5TPEc.686I4S8CVcqC4U3FUAbXRa.UdAUzykl0muy1uS5+4uDzJOO2bJmGKPGBXMmMhbmbzQ=')
kr.loginResult()
...
#km.login(qr=True)
km.login(token='Euaxjy70078xLoiq9xE0.TU/fe15i0bIaRrLrftJUaa.ko8oRGcvfzIq9U/2vjxi75miZ+dzVq+EJCfybWhw61U=')
km.loginResult()
...
┃🇮🇩┃Berapakah Text
┃🇮🇩┃Youtube Judul Video
┃🇮🇩┃Youtubevideo Judul Vid
┃🇮🇩┃Youtubesearch Judul Vid
╰━━━━━━━━━━━━━━━━━━━╯
──┅━✥ ============ ✥━┅──
╭━━━━━━━━━━━━━━━━━━━╮
┣🇮🇩━⏩   KEY MEDIA   🇮🇩━⏩
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,"u65224f4e8812136f01b25275a54b5aef","uc3384e476e108343bce92fc767ec3a24","u3dfecc2c1680a7d6195554f0b62806ca","u554e64f1068a515827ded0dead96741f","uebcea2e2cf1cbc241ce2eddfb9a071ac","uc889c1f8f74274f117e0a0d69ccc559c","ub6ef85135e48d01880ad19511538ee00"]
    ...
    try:
	 ...
	 if wait["Ghost"] == True:
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention1"] == True:          
                    ...
                    cName = contact.displayName
                    balas = ["Nah ..." + cName + ",Gua tau...."]
                    balas1 = "LO PASTI MINTA DIPOTO YAKHAAAN? "
                    balas2 = "SiniH Akoh Potoin SENYUMMMMM😊"
                    ret_ = random.choice(balas)
                    image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
                    name = re.findall(r'@(\w+)', msg.text)
                    mention = ast.literal_eval(msg.contentMetadata['MENTION'])
		...
		cl.sendText(msg.to,"Itu Owner Saya (^_^)")
                ...
                msg.contentType = 13
                admin1 = "uc889c1f8f74274f117e0a0d69ccc559c"
		...
		if msg.from_ in admin:
            ...
            elif msg.text in ["Rpic on"]:
		if msg.from_ in admin:
                    wait["detectMention"] = False
                    wait["detectMention1"] = True
                    wait["kickMention"] = False
                    cl.sendText(msg.to,"Auto Respon Picture Aktif")
		else:
		    cl.sendText(msg.to,"Khusus Admin")

            elif msg.text in ["Rpic off"]:
		if msg.from_ in admin:
                    wait["detectMention1"] = False
                    cl.sendText(msg.to,"Auto Respon Picture  Off")
		else:
		    cl.sendText(msg.to,"Khusus Admin")
...
#		else:                    
		...
		if wait["detectMention1"] == True: md+="┃🇮🇩┃✔️ Auto Rpic : On\n"
		else:md+="┃🇮🇩┃✖ Auto Rpic : Off\n"
		...
		if wait["Simi"] == True: md+="┃🇮🇩┃✔️ Simisimi : On\n"
            ...
            elif msg.text in ["Bot1 gift","arif1 gift"]:
                msg.contentType = 9
            ...
            elif msg.text in ["Bot2 gift","arif2 gift"]:
                msg.contentType = 9
            ...
            elif msg.text in ["Bot3 gift","arif3 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'ae3d9165-fab2-4e70-859b-c14a9d4137c4',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '8'}
		...
		cl.sendText(msg.to,"Pasukan Absen!!")
                ki.sendText(msg.to,"Bot1 Hadiir  \(ˆ▿ˆ)/")
                kk.sendText(msg.to,"Bot2 Hadiir  \(ˆ▿ˆ)/")
                kc.sendText(msg.to,"Bot3 Hadiir  \(ˆ▿ˆ)/")
                kr.sendText(msg.to,"Hadiir Semua Bos  \(ˆ▿ˆ)/")
