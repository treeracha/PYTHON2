...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,"u65224f4e8812136f01b25275a54b5aef"]
...
#		else:                    
		...
		cl.sendText(msg.to,"Pasukan Absen!!")
                ki.sendText(msg.to,"Arif1 Hadiir  \(ˆ▿ˆ)/")
                kk.sendText(msg.to,"Arif2 Hadiir  \(ˆ▿ˆ)/")
                kc.sendText(msg.to,"Arif3 Hadiir  \(ˆ▿ˆ)/")
