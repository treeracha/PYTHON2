...
arif = LINETCR.LINE()
#arif.login(qr=True)
arif.login(token='EtjrnZ5RYomgrI7pO5Ef.zsjptOGse28bSLj1PuTA7W.lYKhD//Vkqno5yaTj/KsVtBNOExWnVwNt/cw1DegQi8=')
arif.loginResult()
...
adminMID = "u65224f4e8812136f01b25275a54b5aef"
...
def restart_program():
    ...
    os.exearif(python, python, * sys.argv)
...
def _images_get_next_item(s):
    ...
    if start_line == -1:    #If no links are found then give an error!
        ...
        start_line = s.find('"arifass="rg_meta"')
...
def upload_tempimage(arifient):
    ...
    image = arifient.upload_from_path(image_path, config=config, anon=False)
    print("Done")
    print()
...
def sendMessage(self, messageObject):
        return self.Talk.arifient.sendMessage(0,messageObject)
...
def sendText(self, Tomid, text):
        ...
        return self.Talk.arifient.sendMessage(0, msg)

def sendImage(self, to_, path):
    M = Message(to=to_, text=None, contentType = 1)
    M.contentMetadata = None
    M.contentPreview = None
    M2 = self._arifient.sendMessage(0,M)
    M_id = M2.id
    files = {
       'file': open(path, 'rb'),
    }
...
def sendImage2(self, to_, path):
    ...
    M.contentMetadata = None
    M.contentPreview = None
    M_id = self._arifient.sendMessage(M).id
    files = {
       'file': open(path, 'rb'),
    }
    params = {
    ...
    r = arif.post_content('https://os.line.naver.jp/talk/m/upload.nhn', data=data, files=files)
    if r.status_code != 201:
       raise Exception('Upload image failure.')
    return True
                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        try:
                                            ...
                                            pass
                                        arif.sendText(op.param1,"Group Name Lock")
            ...
            if mid in op.param3:
                ...
                if wait["autoJoin"] == True:
                    if wait["autoCancel"]["on"] == True:
                        ...
                        arif.sendText(op.param1, "Your invitation was dearifined\n\n[SELF BOT\n[By.☬ധู้さန້ণق↔ധഖาໄฟ☬]]\n\nhttp://line.me/ti/p/9r-uE5EU09")
                    else:
                        arif.acceptGroupInvitation(op.param1)
                        arif.sendText(op.param1, "Your invitation was dearifined\n\n[SEL FBOT\n[By.☬ധู้さန້ণق↔ധഖาໄฟ☬]]\n\nhttp://line.me/ti/p/9r-uE5EU09")
                ...
                if matched_list == []:
                    ...
                    arif.cancelGroupInvitation(op.param1, matched_list)
                ...
                if mid in op.param3:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print ("arifient Kick regulation or Because it does not exist in the group、\n["+op.param1+"]\nの\n["+op.param2+"]\nを蹴る事ができませんでした。\nブラックリストに追加します。")
                ...
                if Amid1 in op.param3:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print ("arifient が蹴り規制orグループに存在しない為、\n["+op.param1+"]\nの\n["+op.param2+"]\nBecause the arifient does not exist in the kick regulation or group.\nAdd it to the blacklist.")
                        if op.param2 in wait["blacklist"]:
                            pass
                        if op.param2 in wait["whitelist"]:
                            pass
                    ...
                    if msg.text is not None:
                        ...
                        if data['status'] == 200:
                            if data['result']['result'] == 100:
                                arif.sendText(msg.to, "[ChatBOT] " + data['result']['response'].encode('utf-8'))                    
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                    if msg.contentMetadata["mid"] in wait["commentBlack"]:
                        ...
                        wait["wblack"] = False
                        arif.sendText(msg.to,"decided not to comment")

               elif wait["dblack"] == True:
                   if msg.contentMetadata["mid"] in wait["commentBlack"]:
                        del wait["commentBlack"][msg.contentMetadata["mid"]]
                        arif.sendText(msg.to,"Done deleted")
                        
                        wait["dblack"] = False

                   else:
                        wait["dblack"] = False
                        arif.sendText(msg.to,"It is not in the black list")
                        
               elif wait["wblacklist"] == True:
                   if msg.contentMetadata["mid"] in wait["blacklist"]:
                        arif.sendText(msg.to,"Done already")

                        wait["wblacklist"] = False
                   else:
                        wait["blacklist"][msg.contentMetadata["mid"]] = True
                        wait["wblacklist"] = False
                        arif.sendText(msg.to,"Done done aded")
                ...
                print "\nHelp pick up..."
                if wait["lang"] == "JP":
                    arif.sendText(msg.to, helpMessage2 + "")
                else:
                    arif.sendText(msg.to,helpt)
            elif msg.text in ["คำสั่ง3"]:
                print "\nHelp pick up..."
                if wait["lang"] == "JP":
                    arif.sendText(msg.to, helpMessage3 + "")
                else:
                    arif.sendText(msg.to,helpt)
                    arif.sendText(msg.to,helpt)
            elif ("Gn:" in msg.text):
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                if wait["winvite"] == True:
                     if msg.from_ == admin:
                         ...
                         for s in groups.members:
                             if _name in s.displayName:
                                 arif.sendText(msg.to,"-> " + _name + " was here")
                                 break
                             elif invite in wait["blacklist"]:
                                 arif.sendText(msg.to,"Sorry, " + _name + " On Blacklist")
                                 arif.sendText(msg.to,"Call my daddy to use command !, \n➡Unban: " + invite)
                                 break                             
                             else:
                         ...
                         if targets == []:
                             ...
                             for target in targets:
                                 try:
                                     ...
                                     arif.sendText(msg.to,"Done Invite : \n➡" + _name)
                                     wait["winvite"] = False
                                     break
                                 except:
                                     try:
                                         ...
                                         arif.sendText(msg.to,"Negative, Error detected")
                                         wait["winvite"] = False
                                         break
            if msg.contentType == 13:
            ...
            if msg.contentType == 13:
                ...
                try:
                    ...
                    results = soup.find(attrs={'arifass':'yt-uix-tile-link'})
                ...
                if msg.from_ in admin:
                    ...
                    for target in targets:
                        try:
                            ...
                            f=codecs.open('st2__b.json','w','utf-8')
                            json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                            arif.sendText(msg.to,"Done Banned")
                ...
                if msg.from_ in admin:
                    ...
                    for target in targets:
                        try:
                            ...
                            f=codecs.open('st2__b.json','w','utf-8')
                            json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                            arif.sendText(msg.to,"Done Unbanned")
                ...
                if msg.from_ in admin:
                    ...
                    if cmd == "on":
                        if mimic["status"] == False:
                            mimic["status"] = True
                            arif.sendText(msg.to,"Mimic on\n\nเปิดการเลียนเเบบ")
                        else:
                            arif.sendText(msg.to,"Mimic already on\n\nเปิดการเลียนเเบบ")
                    elif cmd == "off":
                        if mimic["status"] == True:
                            mimic["status"] = False
                            arif.sendText(msg.to,"Mimic off\n\nปิดการเลียนเเบบ")
                        else:
                            arif.sendText(msg.to,"Mimic already off\n\nปิดการเลียนเเบบ")
                    elif "add:" in cmd:
                        ...
                        if targets == []:
                            arif.sendText(msg.to,"No targets\n\nเกิดผิดพลาด")
                        else:
                            for target in targets:
                                try:
                                    mimic["target"][target] = True
                                    arif.sendText(msg.to,"Success added target")
                                    arif.sendMessageWithMention(msg.to,target)
                                    break
                                except:
                                    arif.sendText(msg.to,"โปรเเกรมเลียนเเบบทำงาน")
                                    break
                    elif "del:" in cmd:
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    arif.sendText(msg.to,"Success deleted target")
                                    arif.sendMessageWithMention(msg.to,target)
                                    break
                                except:
                                    arif.sendText(msg.to,"คุณลบการเลียนเเบบผู้ใช้นี้")
                                    break
                    elif cmd == "list":
                        if mimic["target"] == {}:
                            arif.sendText(msg.to,"No target")
                        else:
                            lst = "<<List Target>>"
                            ...
                            for a in mimic["target"]:
                                if mimic["target"][a] == True:
                                    ...
                                    stat = "Off"
                                lst += "\n-> " + arif.getContact(a).displayName + " | " + stat
                            arif.sendText(msg.to,lst + "\nTotal: " + total)
...
#----------------------------------------------------------------------------
                ...
                arif.sendMessage(msg)
                arif.sendText(msg.to,"Add Line http://line.me/ti/p/9r-uE5EU09")
                arif.sendText(msg.to,"👆 สนใจ บอท ทักมาคุย กันได้นะครับ 👆")
#=========================================
...
#====================================================
            ...
            #VPS STUFF - VPS NEEDED TO RUN THIS COMMAND :)
                 ...
                 if msg.from_ in admin:
                     ...
                     arif.sendText(msg.to,"Command denied.")
                     arif.sendText(msg.to,"Admin permission required.")
				...
				arif.sendText(msg.to, "Let's see who lazy to type")
				try:
...
#==================================================
                ...
                if msg.from_ in admin:
                 wait["winvite"] = True
                 arif.sendText(msg.to,"โปรดส่ง คท ด้วย")
                ...
                if msg.from_ in admin:
                 wait["winvite"] = False
                 arif.sendText(msg.to,"ปิดการเชิญ แล้ว.")
                 ...
                 ki2.sendText(msg.to,"send contact")
                   ...
                   for target in targets:
                       try:
                           ...
                           arif.inviteIntoGroup(msg.to,[target])
                           arif.cancelGroupInvitation(msg.to,[target])
                       except:
                           arif.sendText(msg.to,"Error")
            
            elif '123zzz' in msg.text.lower():
                    key = msg.text[-33:]
                    arif.findAndAddContactsByMid(key)
                    arif.inviteIntoGroup(msg.to, [key])
                    contact = arif.getContact(key)
                ...
                if msg.toType == 2:
                    ...
                    if X.invitee is not None:
                        ...
                        if wait["lang"] == "JP":
                            arif.sendText(msg.to,"No one is inviting。")
                        else:
                            arif.sendText(msg.to,"Sorry, nobody absent")
                else:
                    if wait["lang"] == "JP":
                ...
                if msg.toType == 2:
                    ...
                    arif.updateGroup(X)
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"อนุญาติ ให้มีการเชิญ\nด้วยลิ้งแล้ว👌")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    arif.updateGroup(X)
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"ปิดการเชิญ\nด้วยลิ้งแล้ว👌")
                    else:
                        arif.sendText(msg.to,"already arifose")
                else:
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"Can not be used outside the group")
                    else:
				...
				msg.contentMetadata = {'mid': mid}
				arif.sendMessage(msg)
				arif.sendText(msg.to,"[SELFBOT\nBy:☬ധู้さန້ণق↔ധഖาໄฟ☬]")
            elif "ไอดี" == msg.text:
                key = msg.to
                arif.sendText(msg.to, key)

            elif ("Hack " in msg.text):
                   key = eval(msg.contentMetadata["MENTION"])
                   key1 = key["MENTIONEES"][0]["M"]
                   mi = arif.getContact(key1)
                   arif.sendText(msg.to,"Mid:" + key1)
 ...
 #               arif.sendText(msg.to,""" 􀜁􀇔􏿿􀜁􀇔􏿿[{PHET HACK BOT}] 􀜁􀇔􏿿􀜁􀇔􏿿 \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 #\n\n􀜁􀇔􏿿[Kb1 in]\n􀜁􀇔􏿿[1Aditname:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Pb1 Gift]\n􀜁􀇔􏿿[Pb1 bye]\n\n
...
#""")
                ...
                if msg.toType == 2:
                    ...
                    arif.sendText(msg.to,"I pretended to cancel and canceled(๑و•̀ω•́)و")
                ...
                if wait["protectionOn"] == True:
                    if wait["lang"] == "JP":
                        ...
                        arif.sendText(msg.to,"Protection On\n\n"+ datetime.today().strftime('%H:%M:%S'))
                else:
                ...
                if wait["qr"] == False:
                    if wait["lang"] == "JP":
                        ...
                        arif.sendText(msg.to,"Protection QR PRO Off\n\n"+ datetime.today().strftime('%H:%M:%S'))
                else:
                    wait["qr"] = False
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"Protection QR PRO Off\n\n"+ datetime.today().strftime('%H:%M:%S'))
                ...
                if wait["qr"] == True:
                    if wait["lang"] == "JP":
                        ...
                        arif.sendText(msg.to,"Protection QR PRO On\n\n"+ datetime.today().strftime('%H:%M:%S'))
                else:
                    wait["qr"] = True
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"Protection QR PRO On\n\n"+ datetime.today().strftime('%H:%M:%S'))
                ...
                if wait["protectionOn"] == False:
                    if wait["lang"] == "JP":
                        ...
                        arif.sendText(msg.to,"Protection Off\n\n"+ datetime.today().strftime('%H:%M:%S'))
                else:
                ...
                if msg.to in wait['pname']:
                    arif.sendText(msg.to,"ล็อคชื่อ สำเร็จ.👌..")
                else:
                    arif.sendText(msg.to,"bone..")
                    wait['pname'][msg.to] = True
                    wait['pro_name'][msg.to] = arif.getGroup(msg.to).name
            elif "ปิด ล็อคชื่อ" in msg.text:
                if msg.to in wait['pname']:
                    arif.sendText(msg.to,"ปิด ล็อคชื่อแล้ว.👌.")
				...
				gid = msg.to
				autocancel[gid] = "poni"
				arif.sendText(msg.to,"ปิดการเชิญเข้ากลุ่ม\nของสมาชิกแล้ว.👌.")
            elif "เปิด เชิญ" == msg.text:
				try:
					del autocancel[msg.to]
					arif.sendText(msg.to,"เปิด ให้สมาชิกทุกคน\nสามรถเชิญเพื่อนได้.👌.")
				except:
					pass
            elif "Cn: " in msg.text:
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    arif.sendText(msg.to,"Name " + string + " Done Bosqu")
            elif msg.text in ["invite:on"]:
                if msg.from_ in admin:
                 wait["winvite"] = True
                ...
                if wait["contact"] == True:
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"Sudah on Bosqu")
                    else:
                        arif.sendText(msg.to,"Ok Bosqu")
                else:
                    wait["contact"] = True
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"Sudah on Bosqu")
                ...
                if wait["contact"] == False:
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"Sudah off Bosqu")
                    else:
                        arif.sendText(msg.to,"Ok Bosqu ")
                else:
                    wait["contact"] = False
                ...
                try:
                    ...
                    if strnum == "off":
                        ...
                        if wait["lang"] == "JP":
                            arif.sendText(msg.to,"Invitation refused turned off\nTo turn on please specify the number of people and send")
                        else:
                            arif.sendText(msg.to,"关了邀请拒绝。要时开请指定人数发送")
                    else:
                        num =  int(strnum)
                        wait["autoCancel"]["on"] = True
                        if wait["lang"] == "JP":
                            arif.sendText(msg.to,strnum + " The group of people and below decided to automatically refuse invitation")
                        else:
                            arif.sendText(msg.to,strnum + "使人以下的小组用自动邀请拒绝")
                except:
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"Value is wrong")
                    else:
                        arif.sendText(msg.to,"Bizarre ratings")
                ...
                if wait["timeline"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        arif.sendText(msg.to,"要了关断。")
  
            elif msg.text in ["Like on","เปิด ไลค์"]:
                if wait["likeOn"] == True:
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"เปิดอยู่แล้ว。")
                else:
                    wait["likeOn"] = True
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"เปิดระบบออโต้ไลค์.👌")

            elif msg.text in ["ปิด ไลค์","Like off"]:
                if wait["likeOn"] == False:
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"ปิดอยู่แล้ว")
                else:
                    wait["likeOn"] = False
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"ปิดระบบออโต้ไลค์.👌")
...
#========================================
                ...
                if wait["Protectcanarif"] == True: md+="􀬁􀆐􏿿 Cancel : ✔ 􀜁􀄯􏿿\n"
                ...
                if wait["arifock"] == True: md+="􀬁􀆐􏿿 ชื่อ นาฬิกา : ✔ 􀜁􀄯􏿿\n"
...
#========================================
		...
		if msg.from_ in Creator:
		    arif.sendText(msg.to, "เชลบอท ได้รีสตาร์ตแล้ว.👌\nกรุณาตั้งค่าใหม่อีกครั้ง.👈")
		    restart_program()
		    print "@Restart"
		else:
...
#================================================#           
	           ...
	           if msg.from_ in admin:
                    ...
                    try:
                       arif.findAndAddContactsByMid(gCreator)
                       arif.inviteIntoGroup(msg.to,[gCreator])
...
#============================
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ki1.arifoneContactProfile(target)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ki2.arifoneContactProfile(target)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ki3.arifoneContactProfile(target)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ki4.arifoneContactProfile(target)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ki5.arifoneContactProfile(target)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ki6.arifoneContactProfile(target)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ki7.arifoneContactProfile(target)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ki8.arifoneContactProfile(target)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ki9.arifoneContactProfile(target)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ki10.arifoneContactProfile(target)
...
#================================
		...
		if msg.from_ in Creator:
		    ...
		    arif.sendText(msg.to,"Lu sape!")
#================================= 
            elif msg.text in ["Backup:on","Backup on","เปิด ดึงกลับ","เปิดการเชิญกลับ"]:
                if wait["Backup"] == True:
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"Sudah on Bos\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
                        arif.sendText(msg.to,"Backup On\n\n"+ datetime.today().strftime('%H:%M:%S'))
                else:
                    wait["Backup"] = True
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"Backup On\n\n"+ datetime.today().strftime('%H:%M:%S'))
                ...
                if wait["Backup"] == False:
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"Sudah off Bos\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
                        arif.sendText(msg.to,"Backup Off\n\n"+ datetime.today().strftime('%H:%M:%S'))
                else:
                    wait["Backup"] = False
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"Backup Off\n\n"+ datetime.today().strftime('%H:%M:%S'))
...
#===========================================#
                ...
                if wait["lang"] == "JP":
                    arif.sendText(msg.to,"ปฎิเสธกลุ่มเชิญเรียบร้อยแล้ว.👌")
...
#=============================================#
                    ...
                    if not LINEVITLogged:
                        ...
                        tm = "\n\n"+nowT+":"+nowM+":"+nowS
                        arif.sendText(user1,"ล็อกอินสำเร็จ พร้อมใช้งานแล้ว (｀・ω・´)"+tm)
                    else:
                        arif.sendText(msg.to,"ได้ทำการล็อคอินไปแล้ว")
            elif msg.text.lower() == ".":
                    gs = []
                    try:
                        gs = arif.getGroup(msg.to).members
                    except:
                        try:
                            gs = arif.getRoom(msg.to).contacts
                        except:
                            pass
                    tlist = ""
                    for i in gs:
                    ...
                    if AsulLogged == True:
                        ...
                        arif.sendText(msg.to,"ยังไม่ได้ล็อคอิน")
#========================================#
                ...
                if wait["lang"] == "JP":
                    ...
                    arif.sendText(msg.to,"拒绝了全部的邀请。")
            elif msg.text in ["Y1 rgroups","Y1 rgroup"]:
                gid = ki.getGroupIdsInvited()
                for i in gid:
                    ki.rejectGroupInvitation(i)
                if wait["lang"] == "JP":
                    ki.sendText(msg.to,"Bot All invitations is arifean")
                else:
                ...
                arif.sendText(msg.to,"ทำการลบเรียบร้อย👌")
                arif.sendText(msg.to,"Ok")
...
#                for g in gs.members:
#                    if _nametarget == g.displayName:
#                       arif.sendText(msg.to,"เริ่มทำการรัน")
#                       arif.sendText(g.mid,"[☬Ŧ€ΆM฿❂Ŧ↔Pђãỳãƒir€☬]\n[By.☬ധู้さန້ণق↔ധഖาໄฟ☬]\n http://line.me/ti/p/9r-uE5EU09")
#                       arif.sendText(msg.to, "ทำการรันเรียบร้อย")
#                       print "Done spam"
#========================================

            elif msg.text.lower() == 'ออน':  
                arif.sendText(msg.to, "โปรดรอสักครู่....")
...
#========================================
                ...
                arif.sendText(msg.to,"message changed\n\n"+ datetime.today().strftime('%H:%M:%S'))
                ...
                if wait["lang"] == "JP":
                    arif.sendText(msg.to,"message change to\n\n" + wait["message"])
                else:
                    arif.sendText(msg.to,"The automatic appending information is set as follows。\n\n" + wait["message"])
            elif "Coms set:" in msg.text:
                c = msg.text.replace("คอมเม้น:","Coms set:","")
                if c in [""," ","\n",None]:
                    arif.sendText(msg.to,"String that can not be changed")
                else:
                    wait["comment"] = c
                    arif.sendText(msg.to,"changed\n\n" + c)
                ...
                arif.sendText(msg.to,"message changed to\n\n" + str(wait["comment"]))
            elif msg.text in ["HHX1","Hhx1"]:
                arif.sendText(msg.to,"[เช็คข้อความต้อนรับของคุณ]\n\n" + str(wait["acomment"]))

            elif msg.text in ["HHX2","Hhx2"]:
                arif.sendText(msg.to,"[เช็คข้อความกล่าวถึงคนออกจากกลุ่ม]\n\n" + str(wait["bcomment"]))

            elif msg.text in ["HHX3","Hhx3"]:
                arif.sendText(msg.to,"[เช็คข้อความกล่าวถึงคนลบสมาชิก]\n\n" + str(wait["ccomment"]))

            elif "Hhx1:" in msg.text:
                c = msg.text.replace("Hhx1:","")
                if c in [""," ","\n",None]:
                    arif.sendText(msg.to,"เกิดข้อผิดพลาด..!!")
                else:
                    wait["acomment"] = c
                    arif.sendText(msg.to,"➠ ตั้งค่าข้อความต้อนรับ👌\n\n" + c)
                ...
                if c in [""," ","\n",None]:
                    ...
                    wait["bcomment"] = c
                    arif.sendText(msg.to,"➠ ตั้งค่าข้อความกล่าวถึงคนออกจากกลุ่ม👌\n\n" + c)
                ...
                if c in [""," ","\n",None]:
                    ...
                    wait["ccomment"] = c
                    arif.sendText(msg.to,"➠ ตั้งค่าข้อความกล่าวถึงคนลบสมาชิก👌\n\n" + c)

            elif msg.text in ["Hhx1 on"]:
                if wait["acommentOn"] == True:
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"➠ เปิดข้อความต้อนรับเเล้ว👌")
                    else:
                        arif.sendText(msg.to,"Already on")
                else:
                ...
                if wait["bcommentOn"] == True:
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"➠ เปิดข้อความกล่าวถึงคนออกจากกลุ่ม👌")
                    else:
                        arif.sendText(msg.to,"Already on")
                else:
                ...
                if wait["ccommentOn"] == True:
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"➠ เปิดข้อความกล่าวถึงคนลบสมาชิก👌")
                    else:
                        arif.sendText(msg.to,"Already on")
                else:
                ...
                if wait["acommentOn"] == False:
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"➠ ปิดข้อความต้อนรับเเล้ว👌")
                    else:
                        arif.sendText(msg.to,"Already off")
                else:
                ...
                if wait["bcommentOn"] == False:
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"➠ ปิดข้อความกล่าวถึงคนออกจากกลุ่ม👌")
                    else:
                        arif.sendText(msg.to,"Already off")
                else:
                ...
                if wait["ccommentOn"] == False:
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"➠ ปิดข้อความกล่าวถึงคนลบสมาชิก👌")
                    else:
                        arif.sendText(msg.to,"Already off")
                else:
...
#========================================
                ...
                wait["wblack"] = True
                arif.sendText(msg.to,"add to comment bl")
            elif msg.text in ["Comment wl "]:
                wait["dblack"] = True
                arif.sendText(msg.to,"wl to comment bl")
            elif msg.text in ["Comment bl confirm"]:
                if wait["commentBlack"] == {}:
                    arif.sendText(msg.to,"confirmed")
                else:
                    arif.sendText(msg.to,"Blacklist s")
                    mc = ""
                    for mi_d in wait["commentBlack"]:
                        mc += "・" +arif.getContact(mi_d).displayName + "\n"
                    arif.sendText(msg.to,mc)

            elif msg.text in ["เปิด นาฬิกา","arifock:on","arifock on","Jam on","Jam:on"]:
                if wait["arifock"] == True:
                    arif.sendText(msg.to,"already on")
                else:
                    wait["arifock"] = True
                    now2 = datetime.now()
            ...
            elif msg.text in ["ปิด นาฬิกา","arifock:off","arifock off","Jam off","Jam:off"]:
                if wait["arifock"] == False:
                    arif.sendText(msg.to,"already off")
                else:
                    wait["arifock"] = False
                    arif.sendText(msg.to,"done")
                ...
                if len(n.decode("utf-8")) > 13:
                    ...
                    wait["cName"] = n
                    arif.sendText(msg.to,"Changed to:\n\n" + n)
            elif msg.text in ["Up"]:
                if wait["arifock"] == True:
                    now2 = datetime.now()
                    nowT = datetime.strftime(now2,"༺%H:%M༻")
                    ...
                    profile.displayName = wait["cName"] + nowT
                    arif.updateProfile(profile)
                    arif.sendText(msg.to,"Refresh to update")
                else:
                    arif.sendText(msg.to,"Please turn on the name arifock")
                 ...
                 tts.save('tts.mp3')
                 arif.sendImage(msg.to,"steal.png")
                 arif.sendText(msg.to,"DITAMPILKAN UNTUK TEXT\n" + "" + kata + "\n「SUKSES」")
                 arif.sendAudio(msg.to,'tts.mp3')
                ...
                if msg.toType == 2:
                    ...
                    for g in group.members:
                        if _name == g.displayName:
                            targets.append(g.mid)
                    if targets == []:
                        arif.sendText(msg.to,"Gak da orange")
                    else:
                        for target in targets:
                            try:
                                contact = arif.getContact(target)
                    ...
                    arif.sendText(msg.to,"Tidak bisa dilakukan di luar grup")
...
#========================================
                ...
                try:
                    ...
                    arif.sendText(msg.to, "Backup Sukses Bosqu")
                except Exception as e:
                    arif.sendText(msg.to, str (e))
                    ...
                    if msg.to in wait2['readPoint']:
                        if wait2["ROM"][msg.to].items() == []:
                            ...
                            for rom in wait2["ROM"][msg.to].items():
                                print rom
                                chiya += rom[1] + "\n"
                        arif.sendText(msg.to, "%s\n\n%s\nReadig point creation:\n [%s]\n"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        arif.sendText(msg.to, "Ketik Lurking dulu dudul Baru bilang result Point.")
...
#-----------------------------------------------
              ...
              if msg.from_ in admin:
                if wait["Notifed"] == True:
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"All Notifed On\n\nเปิดเเจ้งเเตือนของคุณเเล้ว")
                    else:
                        arif.sendText(msg.to,"Done\n\nเปิดเเจ้งเเตือนของคุณเเล้ว")
                else:
                    wait["Notifed"] = True
              ...
              if msg.from_ in admin:
                if wait["Notifed"] == False:
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"All Notifed Off\n\nปิดเเจ้งเเตือนของคุณเเล้ว")
                    else:
                        arif.sendText(msg.to,"Done\n\nปิดเเจ้งเเตือนของคุณเเล้ว")
                else:
                    wait["Notifed"] = False
              ...
              if msg.from_ in admin:
                if wait["Notifedbot"] == True:
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"All bot Notifed On\n\nเปิดเเจ้งเเตือนบอทเเล้ว")
                    else:
                        arif.sendText(msg.to,"Done\n\nเปิดเเจ้งเเตือนบอทเเล้ว")
                else:
              ...
              if msg.from_ in admin:
                if wait["Notifedbot"] == False:
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"All bot Notifed Off\n\nปิดเเจ้งเเตือนบอทเเล้ว")
                    else:
                        arif.sendText(msg.to,"Done\n\nปิดเเจ้งเเตือนบอทเเล้ว")
                else:
...
#=================================================
                ...
                if msg.from_ in admin:
                   ...
                   if txt[1] == "on":
                        if jmlh <= 10000:
                             for x in range(jmlh):
                                   arif.sendText(msg.to, teks)
                        else:
                               arif.sendText(msg.to, "Out of range! ")
                   elif txt[1] == "off":
                         if jmlh <= 10000:
                               arif.sendText(msg.to, tulisan)
                         else:
                               arif.sendText(msg.to, "Out of range! ")
#-----------------------------------------------
            elif "Mid @" in msg.text:
...
#-------------------------------------------------
                        ...
                        arif.sendText(msg.to,"[SELF BOT]\n[By.☬ധู้さန້ণق↔ധഖาໄฟ☬]")
                        arif.sendText(msg.to,"Please wait......")
                        arif.sendText(msg.to,"Turn on all protection")
                        arif.sendText(msg.to,"Qr:on")
                        arif.sendText(msg.to,"Backup:on")
                        arif.sendText(msg.to,"Read:on")
                        arif.sendText(msg.to,"Respon:on")
                        arif.sendText(msg.to,"Responkick:on")
                        arif.sendText(msg.to,"Protect:on")
                        arif.sendText(msg.to,"Namelock:on")
                        arif.sendText(msg.to,"Blockinvite:on")


            elif msg.text in ["ปิดหมด","Phet All off","Phet all off"]:
                        arif.sendText(msg.to,"[SELFBOT]\n[By.☬ധู้さန້ণق↔ധഖาໄฟ☬]")
                        arif.sendText(msg.to,"Please wait......")
                        arif.sendText(msg.to,"Turn off all protection")
                        arif.sendText(msg.to,"Qr:off")
                        arif.sendText(msg.to,"Backup:off")
                        arif.sendText(msg.to,"Read:off")
                        arif.sendText(msg.to,"Respon:off")
                        arif.sendText(msg.to,"Responkick:off")
                        arif.sendText(msg.to,"Protect:off")
                        arif.sendText(msg.to,"Namelock:off")
                        arif.sendText(msg.to,"Blockinvite:off")
                        arif.sendText(msg.to,"Link off")

 
            elif msg.text in ["ทีมงาน"]:
                msg.contentType = 13
                arif.sendText(msg.to, "[TEAM SELFBOT]\n[By.☬ധู้さန້ণق↔ധഖาໄฟ☬]")
                arif.sendText(msg.to, "ผู้สร้าง.. SELFBOT\nBy.🔯ധู้さန້ণق↔ധഖาໄฟ🔯")
                msg.contentMetadata = {'mid': 'uf0bd4970771f26a8cef66473d59bcc69'}
                arif.sendMessage(msg)
                arif.sendText(msg.to, "ผู้จัดการ .SELFBOT\nBy.☬ധู้さန້ণق↔ധഖาໄฟ☬")
                msg.contentMetadata = {'mid': 'u6c8aab6ee167a596be2cf045ee2f90df'}
                arif.sendMessage(msg)
                arif.sendText(msg.to, "หวานใจ\nBy.ผู้สร้างพญาไฟ")
                msg.contentMetadata = {'mid': 'u2743230861d1c637647d9ca2a8c1fc14'}
                arif.sendMessage(msg)
                arif.sendText(msg.to, "ประธาน:")
                msg.contentMetadata = {'mid': 'u5b671f4148aa5bbec186b5b7cb295271'}
                arif.sendMessage(msg)
                arif.sendText(msg.to, "รองประธาน:💫 By. พยัค")
                msg.contentMetadata = {'mid': 'u7988143c47d3faacf1856a72011eea93'}
                arif.sendMessage(msg)
                arif.sendText(msg.to, "รปภ.:SELFBOT")
                msg.contentMetadata = {'mid': 'u5b671f4148aa5bbec186b5b7cb295271'}
                arif.sendMessage(msg)
                arif.sendText(msg.to, "ตัวเเทนสมาชิก:By.บอล")
...
#-----------------------------------------------------------
                ...
                try:
                    ...
                    arif.sendText(msg.to,str(arif.channel.createAlbumF(msg.to,name,amid)))
                except Exception as e:
                    try:
                        arif.sendText(msg.to,str(e))
                    except:
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    f=codecs.open('st2__b.json','w','utf-8')
                                    json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                    arif.sendText(msg.to,"Success Boss")
                                except:
                                    arif.sendText(msg.to,"error")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                arif.sendText(msg.to,"Success Masuk daftar orang bejat Boss")
                            except:
                                arif.sendText(msg.to,"Error")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                arif.sendText(msg.to,"Sudah di keluarkan dari daftar bejat Boss")
                            except:
                                arif.sendText(msg.to,"There was no blacklist user")
            elif msg.text in ["arifear ban","ล้างดำ"]:
				wait["blacklist"] = {}
				arif.sendText(msg.to,"arifear")
				
            elif msg.text in ["Ban"]:
                wait["wblacklist"] = True
                arif.sendText(msg.to,"send contact to ban")
                ...
                if wait["blacklist"] == {}:
                    arif.sendText(msg.to,"Nothing 􀨁􀄻double thumbs up􏿿")
                else:
                    arif.sendText(msg.to,"Daftar Banlist􏿿")
                    mc = "[⎈]Blacklist [⎈]\n"
                ...
                if msg.toType == 2:
                    ...
                    for mm in matched_list:
                        cocoa += "\n" + mm + "\n"
                    arif.sendText(msg.to,cocoa + "")

#=============================================
                        
            elif msg.text in ["Simisimi on","Simisimi:on"]:
                settings["simiSimi"][msg.to] = True
                arif.sendText(msg.to,"Success activated simisimi")
                
            elif msg.text in ["Simisimi off","Simisimi:off"]:
                settings["simiSimi"][msg.to] = False
                arif.sendText(msg.to,"Success deactive simisimi")
                
            elif msg.text in ["เปิด อ่าน","Read on","Read:on"]:
                wait['alwayRead'] = True
                arif.sendText(msg.to,"เปิดอ่านข้อความอัตโนมัติ.👌")
                
            elif msg.text in ["ปิด อ่าน","Read off","Read:off"]:
                wait['alwayRead'] = False
                arif.sendText(msg.to,"ปิดอ่านข้อความอัตโนมัติ.👌")
                ...
                arif.sendText(msg.to,"ข้อความแทคล่าสุดคือ\n\n" + str(wait["tag1"]))
                ...
                arif.sendText(msg.to,"Auto Kick ON")
                
            elif msg.text in ["Kicktag off","Autokick:off","Responkick off","Responkick:off"]:
                wait["kickMention"] = False
                arif.sendText(msg.to,"Auto Kick OFF")

            elif msg.text in ["Cancel on","cancel on"]:
              if msg.from_ in admin:
                if wait["Protectcanarif"] == True:
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"Cancel Semua Undangan On")
                    else:
                        arif.sendText(msg.to,"done")
                else:
                    wait["Protectcanarif"] = True
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"Cancel Semua Undangan On")
                    else:
                        arif.sendText(msg.to,"done")
              ...
              if msg.from_ in admin:
                if wait["Protectcanarif"] == False:
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"Cancel Semua Undangan Off")
                    else:
                        arif.sendText(msg.to,"done")
                else:
                    wait["Protectcanarif"] = False
                    if wait["lang"] == "JP":
                        arif.sendText(msg.to,"Cancel Semua Undangan Off")
                    else:
                        arif.sendText(msg.to,"done")
...
#==============================================================================#
                ...
                arif.sendMessage(msg)
                contact = arif.getContact(saya)
                cu = arif.channel.getCover(saya)
                path = str(cu)
                image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
                try:
                    arif.sendText(msg.to,"Nama :\n" + contact.displayName + "\n\nBio :\n" + contact.statusMessage)
                ...
                gid = arif.getGroupIdsJoined()
                for i in gid:
                    h = arif.getGroup(i).id
                    group = arif.getGroup(i)
                    if h == saya:
                        try:
                            ...
                            arif.sendText(msg.to,md)
                            arif.sendMessage(msg)
                            arif.sendImageWithUrl(msg.to,"http://dl.profile.line.naver.jp/"+ group.pictureStatus)
                        except:
                            creator = "Error"
                ...
                gid = arif.getAllContactIds()
                for i in gid:
                    h = arif.getContact(i).displayName
                    contact = arif.getContact(i)
                    cu = arif.channel.getCover(i)
                    path = str(cu)
                    image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
                    if h == saya:
                        arif.sendText(msg.to,"Nama :\n" + contact.displayName + "\n\nBio :\n" + contact.statusMessage)
                ...
                for i in gid:
                    h += "%s\n" % (arif.getGroup(i).name +" ? ["+str(len(arif.getGroup(i).members))+"]")
                arif.sendText(msg.to,"-- List Groups --\n\n"+ h +"\nTotal groups =" +" ["+str(len(gid))+"]")                            
                ...
                if msg.to in wait2['readPoint']:
                    ...
                    with open('sider.json', 'w') as fp:
                     json.dump(wait2, fp, sort_keys=True, indent=4)
                     arif.sendText(msg.to, "เปิดการอ่านอัตโนมัต\nSet reading point:\n" + datetime.now().strftime('%H:%M:%S'))
                     print wait2
                ...
                if msg.to not in wait2['readPoint']:
                    ...
                    try:
                          ...
                          pass
                    arif.sendText(msg.to, "ปิดการอ่านอัตโนมัต\nDelete reading point:\n" + datetime.now().strftime('%H:%M:%S'))
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        arif.sendText(msg.to,"lurk on")
            elif msg.text in ["ปิดอ่าน","R off"]:
                        arif.sendText(msg.to,"lurk off")
            ...
            elif msg.text in ["Miarifist","Heckmic"]:
                        if mimic["target"] == {}:
...
#==============================================================================#
                ...
                if len(string.decode('utf-8')) <= 10000000000:
                    ...
                    profile.displayName = string
                    arif.updateProfile(profile)
                    arif.sendText(msg.to,"Changed " + string + "")
                ...
                arif.sendImageWithUrl(msg.to,path)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               arif.arifoneContactProfile(target)
                               arif.sendText(msg.to, "Copied.")
                            except Exception as e:
                                print e
            elif msg.text in ["Mybb"]:
                try:
                    arif.updateDisplayPicture(backup.pictureStatus)
                    arif.updateProfile(backup)
                    arif.sendText(msg.to, "Refreshed.")
                except Exception as e:
                    arif.sendText(msg.to, str(e))
 
#==========================================================#
            elif "[Auto Respond]" in msg.text:
                arif.sendImageWithUrl(msg.to, "http://dl.profile.line.naver.jp/0hlGvN3GXvM2hLNx8goPtMP3dyPQU8GSIgJVUpCTpiPVtiA3M2arifJ-C2hia11mUn04cAJ-DWljOVBj")
                ...
                tts.save('hasil.mp3')
                arif.sendAudioWithUrl(msg.to,'hasil.mp3')
                ...
                arif.sendAudioWithUrl(msg.to,"hasil.mp3")
                  ...
                  tts.save('tts.mp3')
                  arif.sendAudioWithUrl(msg.to,'tts.mp3')
                ...
                try:
                    ...
                    arif.sendVideoWithUrl(msg.to, ght)
                except:
                    arif.sendText(msg.to,"Could not find it")            
                ...
                try:
                  ...
                  try:
                      ...
                      arif.sendText(msg.to, pesan)
                          ...
                          try:
                              pesan="Over Text Limit! Please arifick link\n"
                              pesan+=wikipedia.page(wiki).url
                              arif.sendText(msg.to, pesan)
                          except Exception as e:
                              arif.sendText(msg.to, str(e))
                ...
                try:
                    ...
                    for song in data:
                        ...
                        arif.sendText(msg.to, hasil)
                        arif.sendText(msg.to, "Please Wait for audio...")
                ...
                try:
                    ...
                    try:
                        ...
                        text = "Name : "+namaIG+"\nUsername : "+usernameIG+"\nBiography : "+bioIG+"\nFollower : "+followerIG+"\nFollowing : "+followIG+"\nPost : "+mediaIG+"\nVerified : "+verifIG+"\nPrivate : "+privateIG+"" "\n" + link
                        arif.sendImageWithUrl(msg.to, profileIG)
                        arif.sendText(msg.to, str(text))
                    except Exception as e:
                        arif.sendText(msg.to, str(e))
...
#========================================================#
                ...
                if wait["blacklist"] == {}:
                    arif.sendText(msg.to,"Tidak Ada Blacklist")
                else:
                    arif.sendText(msg.to,"Daftar Banlist")
                    num=1
                    msgs="══════════List Blacklist═════════"
                    for mi_d in wait["blacklist"]:
                ...
                if wait["blacklist"] == {}:
                    ...
                    arif.sendText(msg.to,"Daftar Blacklist")
                    h = ""
...
#==============================================#
              ...
              if msg.from_ in admin:
                ...
                cu = arif.channel.getCover(key1)
                try:
                    arif.sendText(msg.to,"[name]\n" + contact.displayName + "\n[mid]\n" + contact.mid + "\n[statusmessage]\n" + contact.statusMessage + "\n[profilePicture]\nhttp://dl.profile.line-cdn.net/" + contact.pictureStatus + "\n[homePicture]\n" + str(cu))
                except:
                    arif.sendText(msg.to,"[name]\n" + contact.displayName + "\n[mid]\n" + contact.mid + "\n[statusmessage]\n" + contact.statusMessage + "\n[homePicture]\n" + str(cu))
#=============================================
            elif msg.text in ["!Sp"]:
                start = time.time()
                arif.sendText(msg.to, "Waiting...")
                elapsed_time = time.time() - start
                arif.sendText(msg.to, "%sTamii Server" % (elapsed_time))
              ...
              if msg.from_ in admin:
                ...
                for target in targets:
                   try:
                      ...
                      f=codecs.open('st2__b.json','w','utf-8')
                      json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                      arif.sendText(msg.to,"Succes Banned Bos")
                   except:
                      pass        
       #-------------Fungsi Respon Start---------------------#
                ...
                if wait["blacklist"] == {}:
                    ...
                    xname = ""
                    for mi_d in wait["blacklist"]:
                        xname = arif.getContact(mi_d).displayName + ""
                ...
                arif.sendText(msg.to,X)
                    ...
                    with requests.session() as s:
                        ...
                        r    = s.get(url, params=params)
                        mp3  = r.url
                        arif.sendAudioWithUrl(msg.to, mp3)
            elif "siri:" in msg.text.lower():
                    query = msg.text.lower().replace("siri:","")
                    with requests.session() as s:
                        s.headers['user-agent'] = 'Mozilla/5.0'
                  ...
                  try:
                      ...
                      arif.sendText(msg.to, pesan)
                          ...
                          try:
                              pesan="Text Terlalu Panjang Silahkan arifick link di bawah ini\n"
                              pesan+=wikipedia.page(wiki).url
                              arif.sendText(msg.to, pesan)
                          except Exception as e:
                              arif.sendText(msg.to, str(e))
                ...
                ultah = data["data"]["ultah"]
                zodiak = data["data"]["zodiak"]
                arif.sendText(msg.to,"Tanggal Lahir : "+lahir+"\n\nUmur : "+usia+"\n\nUltah : "+ultah+"\n\nZodiak : "+zodiak)
            elif "dearifined" in msg.text:
                if msg.toType == 2:
                    ginfo = arif.getGroup(msg.to)
                    try:
        ...
        if op.type == 25:
            ...
            if msg.text.lower() in ["pheytcg fgtagg all"]:
                ...
                if jml > 400 and jml < 500:
                    ...
                    mention(msg.to, nm5)
                if jml > 500:
                    arif.sendText(msg.to,'Member melebihi batas.')
                cnt = Message()
        ...
        if op.type == 26:
            ...
            if msg.text.lower() in ["1123"]:
                ...
                arif.sendMessage(cnt)
                        ...
                        arif.sendText(msg.to,"😆เช็คจัง กลัวบอทหลุด ล่ะสิ😆")

            elif msg.text in ["เทสบอท"]:
                        arif.sendText(msg.to,"SELF BOT\n[By.☬ധู้さန້ণق↔ധഖาໄฟ☬]")

            elif msg.text in [".อยู่ไหม"]:
                        arif.sendText(msg.to,"อยู่...")

            elif msg.text in ["/อยู่ไหม"]:
                        arif.sendText(msg.to,"เรื่องของกู...")

            elif msg.text in ["/ออนไหม"]:
                        arif.sendText(msg.to,"ออน")

            elif msg.text in ["/ปิดป้องกัน"]:
                        arif.sendText(msg.to,"ปิดป้องกัน")
                ...
                if msg.to in wait2['readPoint']:
                    ...
                    with open('sider.json', 'w') as fp:
                     json.dump(wait2, fp, sort_keys=True, indent=4)
                     arif.sendText(msg.to, "โปรเเกรมเปิดการอ่านอัตโนมัต\nSet reading point:\n" + datetime.now().strftime('%H:%M:%S'))
                     print wait2
                ...
                if msg.to not in wait2['readPoint']:
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        arif.sendText(msg.to, "กรุณาตั้งเวลาการอ่านใหม่อีกครั้งโปรดพิมพ์ ➠ /ตั้งเวลา")
            elif msg.from_ in mimic["target"] and mimic["status"] == True and mimic["target"][msg.from_] == True:
            	text = msg.text
            	if text is not None:
            		arif.sendText(msg.to, "[อัตโนมัติ]: " + text)
            	else:
            		if msg.contentType == 7:
            			msg.contentType = 7
            			msg.text = None
        ...
        if op.type == 15:
            if wait["Notifedbot"] == True:
                if op.param2 in Bots:
                    return
                ki1.sendText(op.param1,arif.getContact(op.param2).displayName + "\n\n􀜁􀄄􏿿 Bye~bye 􀜁􀄄􏿿")
                ki2.sendText(op.param1,arif.getContact(op.param2).displayName + "\n\n􀜁􀄄􏿿 Bye~bye 􀜁􀄄􏿿")
                print "MEMBER OUT GROUP"
        ...
        if op.param3 == "1":
            if op.param1 in protectname:
                ...
                try:
					...
					arif.sendText(op.param1, "Groupname protect now")
					wait["blacklist"][op.param2] = True
					f=codecs.open('st2__b.json','w','utf-8')
					json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                except Exception as e:
