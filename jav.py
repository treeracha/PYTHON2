...
cl = LINETCR.LINE()
cl.login(token="EvBkpzcHkk04p7BbSlhb.0PzLwS72Fl1EGGJMnIN3IW.L+gJt+LxFiDF0Vb2L0gqfZhzX+8o2FVaTg2tpafd+GU=")

ki = LINETCR.LINE()
ki.login(token="EvaWbxALUuhh7mi5tF5f.zsjptOGse28bSLj1PuTA7W.EmslibnnCJRjksdHEEG4nCRZCSqn26aeIUSgr18FWwg=")

ki2 = LINETCR.LINE()
ki2.login(token="EvKKx44iCCWJUFarleq3.ceM9NaolFHDUaV2+G8nZyW.oXv80pxiSwE2sqts+eNL28zaVhTebSPnXeHsX3BgJFk=")

#ki3 = LINETCR.LINE()
#ki3.login(token="Esth9hoN2wdZ7jTX4Zke.XGWn96LGOFJ1a1yTFcngFG.VMcl6QihZcN/dWUQI4QDr1j7OpZDRI99nNw5yK/zU2c=")

#ki4 = LINETCR.LINE()
#ki4.login(token="EsEdsubh7cVO1aUkWWI6.nAooghU4e54qsOYN8g+MnG.yCWV9Jkdk2WcoRrv+j09nnJL51bDBy/MSjN4te4oe/A=")

#ki5 = LINETCR.LINE()
#ki5.login(token="EsKDS4wXJOWoY6ntUd29.VMasV1yUslq2OxwUXK8HUq.RA8/RGvmGtUf/mKb/Xzu0zRnSr98hGD8vyuCpFgdvuo=")

#ki6 = LINETCR.LINE()
#ki6.login(token="EsoOF1RmUR43ymHyvAF7.511gSgvyAPO7ebgM9hm1LW.pez1vViF0wnMehh0ab0jc/ZEQ+8n3VGNtfwhomdifUc=")

#ki7 = LINETCR.LINE()
#ki7.login(token="EstUSoVdM545Aew3RSQ8.mgmQuo0vlvrejSOkSmea/a.8aoMrpwUn9P/PCl8PUmHXdX7/nphV6y7aHjfmryITGw=")

#ki8 = LINETCR.LINE()
#ki8.login(token="EsIfufXtVh3i8djVznW9.c0zuq/65uNn+Skymv5pqgq.XEV5ZkkhY4TXKmkYBaWF/ThA/QcTk969Iii/f/Ujczc=")
...
admsa = "uc889c1f8f74274f117e0a0d69ccc559c"
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "uc889c1f8f74274f117e0a0d69ccc559c":
                    if "join:" in msg.text:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                if wait["lang"] == "JP":
                    ...
                    cl.sendText(msg.to,helpMessage)
            elif 'Gname ' in msg.text.lower():
                if msg.toType == 2:
                    arif = cl.getGroup(msg.to)
                    arif.name = msg.text.replace("Gname ","")
                    cl.updateGroup(arif)
            elif "Kick" in msg.text:
                midd = msg.text.replace("Kick","")
                cl.kickoutFromGroup(msg.to,[midd])
            elif 'Kinvite ' in msg.text.lower():
                    key = msg.text[-33:]
                    cl.findAndAddContactsByMid(key)
                    cl.inviteIntoGroup(msg.to, [key])
                    contact = cl.getContact(key)
            elif msg.text.lower() == 'MyPartner':
                msg.contentType = 13
                ...
                cl.sendMessage(msg)
            elif msg.text.lower() == 'おれ':
                msg.contentType = 13
                msg.contentMetadata = {'mid': mid}
                cl.sendMessage(msg)
            elif msg.text.lower() == 'ナルト':
                msg.contentType = 13
                msg.contentMetadata = {'mid': kimid}
                ki.sendMessage(msg)
            elif msg.text.lower() == 'ﾏﾀﾞラ':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki2mid}
                ki2.sendMessage(msg)
            elif msg.text.lower() == 'ﾊｼﾗﾏ':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki3mid}
                ki3.sendMessage(msg)
            elif msg.text.lower() == 'ﾄﾋﾞﾗﾏ':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki4mid}
                ki4.sendMessage(msg)
            elif msg.text.lower() == 'ﾍﾟｲﾝ':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki5mid}
                ki5.sendMessage(msg)
            elif msg.text.lower() == 'ｲﾀﾁ':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki6mid}
                ki6.sendMessage(msg)
            elif msg.text.lower() == 'ｷｻﾒ':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki7mid}
                ki7.sendMessage(msg)
            elif msg.text.lower() == 'ｻｿﾘ':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki8mid}
                ki8.sendMessage(msg)
            elif msg.text.lower() == 'ﾃﾞｲﾀﾞﾗ':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki9mid}
                ki9.sendMessage(msg)
            elif msg.text.lower() == 'ｶｸｽﾞ':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki10mid}
                ki10.sendMessage(msg)
            elif msg.text.lower() == 'ﾋﾀﾞﾝ':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki11mid}
                ki11.sendMessage(msg)
            elif msg.text.lower() == 'ｵﾛﾁﾏﾙ':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki12mid}
                ki12.sendMessage(msg)
            elif msg.text.lower() == 'ﾄﾋﾞ':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki13mid}
                ki13.sendMessage(msg)
            elif msg.text.lower() == 'ｶｶｼ':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki14mid}
                ki14.sendMessage(msg)
            elif msg.text.lower() == 'ｻｲ':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki15mid}
                ki15.sendMessage(msg)
            elif msg.text.lower() == 'ﾔﾏﾄ':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki16mid}
                ki16.sendMessage(msg)
            elif msg.text.lower() == 'ﾐﾅﾄ':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki17mid}
                ki17.sendMessage(msg)
            elif msg.text.lower() == 'ｸｼﾅ':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki18mid}
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"QRコードを解錠しました")
                    else:
                        cl.sendText(msg.to,"QRコードを解錠しました")
                else:
                    if wait["lang"] == "JP":
                ...
                if msg.toType == 2:
                    ...
                    cl.updateGroup(group)
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"QRコードをロックしました")
                    else:
                        cl.sendText(msg.to,"QRコードをロックしました")
                else:
                    if wait["lang"] == "JP":
                ...
                cl.sendMessage(msg)
            elif msg.text.lower() == '俺のid':
                cl.sendText(msg.to,mid)
            elif msg.text.lower() == 'ナルトのid':
                ki.sendText(msg.to,kimid)
            elif msg.text.lower() == 'マダラのid':
                ki2.sendText(msg.to,ki2mid)
            elif msg.text.lower() == 'ハシラマのid':
                ki3.sendText(msg.to,ki3mid)
            elif msg.text.lower() == 'トビラマのid':
                ki4.sendText(msg.to,ki4mid)
            elif msg.text.lower() == 'ペインのid':
                ki5.sendText(msg.to,ki5mid)
            elif "みんなのID" == msg.text:
                ki.sendText(msg.to,kimid)
                ki2.sendText(msg.to,ki2mid)
                ki3.sendText(msg.to,ki3mid)
                ki4.sendText(msg.to,ki4mid)
                ...
                if len(string.decode('utf-8')) <= 500:
                    ...
                    profile.statusMessage = string
                    ki18.updateProfile(profile)
                    cl.sendText(msg.to,"STATUSはこうなった " + string + "")
                if msg.text == "Read":
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    cl.sendText(msg.to,"名前もうこうなった : " + string + "")
#---------------------------------------------------------
...
#--------------------------------------------------------
                ...
                if wait["contact"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"コンタクトONしました")
                    else:
                ...
                if wait["contact"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"コンタクトOFFしました")
                    else:
                        cl.sendText(msg.to,"もうしました")
                else:
                    wait["contact"] = False
                ...
                if wait["protect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ジョインプロテクションONしました")
                    else:
                        cl.sendText(msg.to,"もうしました")
                else:
                    wait["protect"] = True
                ...
                if wait["linkprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"プロQRコードONしました")
                    else:
                        cl.sendText(msg.to,"もうしました")
                else:
                ...
                if wait["cancelprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"プロキャンセルONしました")
                    else:
                        cl.sendText(msg.to,"もうしました")
                else:
                ...
                if wait["autoJoin"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"アウトジョインONしました")
                    else:
                        cl.sendText(msg.to,"もうしました")
                else:
                    wait["autoJoin"] = True
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"もうしました")
            elif msg.text.lower() == 'UserBlacklist':
            ...
            elif msg.text.lower() == 'アウトジョインoff':
                if wait["autoJoin"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"アウトジョインOFFしました")
                    else:
                        cl.sendText(msg.to,"もうしました")
                else:
                    wait["autoJoin"] = False
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"もうしました")
            elif msg.text.lower() == 'プロジョインoff':
                if wait["protect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"プロテクトOFFしました")
                    else:
                        cl.sendText(msg.to,"もうしました")
                else:
                    wait["protect"] = False
                ...
                if wait["linkprotect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"プロQRコードOFFしました")
                    else:
                        cl.sendText(msg.to,"もうしました")
                else:
                ...
                if wait["inviteprotect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"プロ招待OFFしました")
                    else:
                        cl.sendText(msg.to,"もうしました")
                else:
                ...
                if wait["cancelprotect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"プロキャンセルOFFしました")
                    else:
                        cl.sendText(msg.to,"もうしました")
                else:
                ...
                if wait["leaveRoom"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Auto Leave room already off")
            elif msg.text.lower() == 'シェアon':
                if wait["timeline"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"シェアONしました")
                    else:
                        cl.sendText(msg.to,"もうしました")
                else:
                    wait["timeline"] = True
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"もうしました")
            elif msg.text.lower() == 'シェアoff':
                if wait["timeline"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"シェアOFFしました")
                    else:
                        cl.sendText(msg.to,"もうしました")
                else:
                    wait["timeline"] = False
                ...
                if album["result"]["items"] == []:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ALBUMがなさそうだ")
                    else:
                ...
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"招待をキャンセルする")
                else:
                    cl.sendText(msg.to,"He declined all invitations")
            elif "Albumdell" in msg.text:
                gid = msg.text.replace("Albumdell","")
                ...
                if wait["autoAdd"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"追加するモードONしました")
                    else:
                        cl.sendText(msg.to,"もうしました")
                else:
                    wait["autoAdd"] = True
                ...
                if wait["autoAdd"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"追加するモードOFFしました")
                    else:
                        cl.sendText(msg.to,"もうしました")
                else:
                    wait["autoAdd"] = False
                ...
                wait["message"] = msg.text.replace("Set pesan","")
                ...
                if wait["lang"] == "JP":
                    ...
                    cl.sendText(msg.to,"Pesan tambahan otomatis telah ditetapkan sebagai berikut \n\n" + wait["message"])
            elif "Set Com" in msg.text:
                c = msg.text.replace("Set Com","")
                if c in [""," ","\n",None]:
                    cl.sendText(msg.to,"Merupakan string yang tidak bisa diubah")
                else:
                    wait["comment"] = c
                    cl.sendText(msg.to,"Ini telah diubah👈\n\n" + c)
            elif msg.text in ["コメントON"]:
                if wait["commentOn"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"俺は今どこかの")
                    else:
                        cl.sendText(msg.to,"開く")
                else:
                    wait["commentOn"] = True
                    if wait["lang"] == "JP":
            ...
            elif msg.text in ["コメントOFF"]:
                if wait["commentOn"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"コメントOFFしました")
                    else:
                        cl.sendText(msg.to,"もうしました")
                else:
            ...
            elif msg.text in ["コメント"]:
                cl.sendText(msg.to,"アウトコメントはこちらで👈\n\n" + str(wait["comment"]))
            elif msg.text.lower() == 'qrは':
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ここではできないぞ")
                    else:
                        cl.sendText(msg.to,"グループでしかできない")
            elif msg.text.lower() == 'ナルトqrは':
                if msg.toType == 2:
                    g = cl.getGroup(msg.to)
                    if g.preventJoinByTicket == True:
                        g.preventJoinByTicket = False
...
#-----------------------------------------------------------
                ...
                if msg.toType == 2:
                        ...
                        _name = msg.text.replace("やれ！ ","")
                        gs = cl.getGroup(msg.to)
                        cl.sendText(msg.to,"もういい終わりにする！")
                        ki.sendText(msg.to,"ああ、やってやろう！")
                        targets = []
                        for g in gs.members:
                ...
                if msg.toType == 2:
                    ...
                    if targets == []:
                        ...
                        ki6.sendText(msg.to,"いない")
                        ki2.sendText(msg.to,"いない")
                    else:
                        for target in targets:
                            try:
                                klist=[ki]
                                ...
                                ki.sendText(msg.to,"すぐに終わらせてやる")
                                ki6.sendText(msg.to,"これ以上語るまい")
                                ki2.sendText(msg.to,"強がるな、だから貴様は倒れているんのだ")
#-----------------------------------------------------------
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                cl.sendText(msg.to,_nametarget + " ブロックリストに入れたぞ")
                            except:
                                cl.sendText(msg.to,"Error")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                cl.sendText(msg.to,_nametarget + " 今回だけは許してやる")
                            except:
...
#-----------------------------------------------------------speed
                ...
                if wait["blacklist"] == {}:
                    ...
                    if msg.to in wait['readPoint']:
                        ...
                        wait['ROM'][msg.to] = {}
                        print wait
                        cl.sendText(msg.to, "隠れるのはもう意味だ！")
                    else:
                        cl.sendText(msg.to, "出てきて法がいい")
                        print "ReadPoint Set..."
                        try:
                            del wait['readPoint'][msg.to]
                            del wait['readMember'][msg.to]
...
#-----------------------------------------------
                        ...
                        ki18.updateGroup(G)
#-----------------------------------------------
            elif msg.text.lower() == 'もういいお前ら戻れ':
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        cl.sendText(msg.to,"􀠁􀆩􏿿じゃまたな〜"  +  str(ginfo.name)  + "")
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        pass
#-----------------------------------------------
            elif "HASHIRAMA OUT" in msg.text:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ki3.leaveGroup(msg.to)
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        pass
#-----------------------------------------------
            elif "OROCHIMARU OUT" in msg.text:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ki12.leaveGroup(msg.to)
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"""      􀠁􀆩􏿿􀠁􀆩􏿿 TZ Team [KB] 􀠁􀆩􏿿􀠁􀆩􏿿  \n\n 􀠁􀆩􏿿 key Only Kicker 􀠁􀆩􏿿 \n\n􀠁􀆩􏿿[Kb1 in]\n􀠁􀆩􏿿[1name:]\n􀠁􀆩􏿿[B Cancel]\n􀠁􀆩􏿿[kick @]\n􀠁􀆩􏿿[Ban @]\n􀠁􀆩􏿿[kill]\n􀠁􀆩􏿿[BotChat]\n􀠁􀆩􏿿[Respons]\n􀠁􀆩􏿿[Kb1 Gift]\n􀠁􀆩􏿿[Kb1 bye]\n\n   
...
#-----------------------------------------------
            ...
            elif "Bctext " in msg.text:
				bctxt = msg.text.replace("Bctext ","")
...
#---------------FUNGSI RATAIN GRUP TANPA KICK SESAMA BOT/Admin/Bots----------#
            elif "GASSS POLLL" in msg.text:
              if msg.from_ in Bots:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("GASSS POLLL🙏","")
                    gs = ki.getGroup(msg.to)
                    gs = ki2.getGroup(msg.to)
                    gs = ki3.getGroup(msg.to)
                    ki.sendText(msg.to,"すまないがこのグループ調べさせてもらうぞ")
                    ki5.sendText(msg.to,"神の力を見せてやろう")
                    ki4.sendText(msg.to,"負けられん理由がある\nお前にもいずれわかろ")
                    ki2.sendText(msg.to,"あれを使うか")
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': mid}
                    ki3.sendMessage(msg)
                    targets = []
                        ...
                        for target in targets:
                          if target not in Bots:
                            try:
                                ...
                                ki.sendText(msg.to,"すぐに終わらせてやる")
                                ki2.sendText(msg.to,"もうキボウなどない")
                                ki3.sendText(msg.to,"これぞ、神の力！")
                                ki4.sendText(msg.to,"避雷針の術！")
#-----------------------------------------------
            elif "Mid @" in msg.text:
