...
cl = LINETCR.LINE()
cl.login(token="Ev4TKNHIcHLeyWbUPoPb.0PzLwS72Fl1EGGJMnIN3IW.O7+gQg9zXOL1Yz7F7gH3lVp5yZBEQQpsvZ4ShDDYC2c=")
cl.loginResult()
print """
⏩ƛƦƖƑƖƧƬƖƑƖƘ⏪
"""
...
ki10 = ki9 = ki8 = ki7 = ki6 = ki5 = ki4 = ki3 = ki2 = ki1 = cl
helpMessage ="""   
...
╠❂͜͡☬➣ M on =ข้อความต้อนรับ
╠❂͜͡☬➣ M off =ข้อความต้อนรับ
╠❂͜͡☬➣ Hhx1 on =เปิดข้อความเข้ากลุ่ม
╠❂͜͡☬➣ Hhx1 off =ปิดข้อความออกกลุ่ม
╠❂͜͡☬➣ Hhx2 on =เปิดข้อความออกกลุ่ม
╠❂͜͡☬➣ Hhx2 off =ปิดข้อความออกกลุ่ม
╠❂͜͡☬➣ Hhx3 on =เปิดข้อความคนเตะกัน
╠❂͜͡☬➣ Hhx3 off =ปิดข้อความคนเตะกัน
╠❂͜͡☬➣ Mbot on = เปิดเเจ้งเตือนบอท
╠❂͜͡☬➣ Mbot off = ปิดเเจ้งเตือนบอท
╠❂͜͡☬➣ M on = เปิดเเจ้งเตือนตนเอง
╠❂͜͡☬➣ M off = ปิดเเจ้งเตือนตนเอง
╠❂͜͡☬➣ Tag on = เปิดกล่าวถึงเเท็ก
╠❂͜͡☬➣ Tag off =ปิดกล่าวถึงเเท็กกัน
╠❂͜͡☬➣ Kicktag on =เปิดเตะคนเเท็ก
╠❂͜͡☬➣ Kicktag off =ปิดเตะคนเเท็ก
╠❂͜͡☬➣ Hhx1; =ใส่ข้อความต้อนรับ
╠❂͜͡☬➣ Hhx2; =ใส่ข้อความออกจากกลุ่ม
╠❂͜͡☬➣ Hhx3; =ใส่ข้อความเมื่อมีคนเตะกัน
╠❂͜͡☬➣ Tag1;  =ใส่ข้อความคนแท็กที่1
╠❂͜͡☬➣ Tag2;  =ใส่ข้อความคนแท็กที่2
╠❂͜͡☬➣ Hhx1 = เช็คข้อความต้อนรับ
╠❂͜͡☬➣ Hhx2 = เช็คข้อความคนออก
╠❂͜͡☬➣ Hhx3 = เช็คข้อความคนเตะกัน
╠❂͜͡☬➣ Tag 1  = เช็คข้อความแท็กที่1
╠❂͜͡☬➣ Tag 2  = เช็คข้อความแท็กที่2
╚══【✥🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁✥】══╝"""
Thaihelp =""" 
        ||=======================||
         ⏪⏩ 🍁sᴇʟғʙᴏᴛ ᴛʜᴀɪʟᴀɴᴅ 🍁⏪⏩
...
🍁⏪⏩🍁สหาย  - เชคคท.คิกเกอร์ทั้งหมด
🍁⏪⏩🍁มาหำ  - เรียกคิกเกอร์เข้ากลุ่ม
🍁⏪⏩🍁บายหำ  - สั่งคิกเกอร์ออกกลุ่ม
🍁⏪⏩🍁1-10 in  - เรียกคิกเกอร์
🍁⏪⏩🍁1-10 bye. - สั่งคิกเกอร์ออก
🍁⏪⏩🍁.แทค  - แทคสมาชิก
🍁⏪⏩🍁แอบ   - ตั้งจุดเชคคนอ่าน
🍁⏪⏩🍁ส่อง  - เชครายชื่อคนอ่าน
🍁⏪⏩🍁เชคกลุ่ม  - เชคข้อมูลกลุ่ม
🍁⏪⏩🍁กลุ่ม  - เชคกลุ่มที่มีทั้งหมด
🍁⏪⏩🍁เชิญ  - เชิญคนเข้ากลุ่มด้วยคท.
🍁⏪⏩🍁ขาว  - แก้ดำ(ส่งคท.)
🍁⏪⏩🍁ดำ @ - ยัดดำ
🍁⏪⏩🍁เชคดำ  - เชคบัญชีดำ
🍁⏪⏩🍁เชคดำ2 - จะขึ้น คท คนติดดำ
🍁⏪⏩🍁ล้างดำ  - ล้างบัญชี 
...
🍁⏪⏩🍁ข้อความรูป - มีรูปข้อความกับเสียง
🍁⏪⏩🍁พูด - สั่งสิริ
🍁⏪⏩🍁เพื่อนทั้งหมด - เช็คเพื่อน
🍁⏪⏩🍁Music - ขอเพลง
🍁⏪⏩🍁บค็อค - เช็คคนที่บ๊อค
🍁⏪⏩🍁แจก - ของขวัญ
🍁⏪⏩🍁ออน - เช็คเวลาบอท
🍁⏪⏩🍁ส่งแขก @ - เตะ
🍁⏪⏩🍁Kill - สั่งคิกเตะคนติดดำ
🍁⏪⏩🍁botkill - เตะคนติดดำ
...
#----------------------------------------------------------------------------
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to,"Add Line http://line.me/ti/p/~arif.mhmini_siri")
...
#==================================================
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    ki.updateProfile(profile)
                        ...
                        ki1.sendText(msg.to,"[🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁➤")
                ...
                cl.sendText(msg.to,"""┅═✥हई✯🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁✯ईह✥═┅\n
...
#==================================================
				...
				msg.contentMetadata = {'mid': mid}
				cl.sendMessage(msg)
				cl.sendText(msg.to,"┅═✥हई✯🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁✯✥═┅")
            elif "Id" == msg.text:
                key = msg.to
                ...
                cl.sendText(msg.to,""" 􀜁􀇔􏿿􀜁􀇔􏿿┅═✥हई✯🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁✯ईह✥═┅􀇔􏿿􀜁􀇔􏿿 \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb1 in]\n􀜁􀇔􏿿[1Aditname:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Pb1 Gift]\n􀜁􀇔􏿿[Pb1 bye]\n\n
""")
...
#========================================
                ...
                md = "〚By.🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁〛\n"
                if wait["likeOn"] == True: md+="❂͜͡☬➣ Auto like ➣ on 🔵\n"
                else:md+="❂͜͡☬➣ Auto like ➣ off  🔴\n"
                if wait["alwayRead"] == True: md+="❂͜͡☬➣ Read ➣ on 🔵\n"
                else:md+="❂͜͡☬➣ Read ➣ off  🔴\n"
                if wait["detectMention"] == True: md+="❂͜͡☬➣ Autorespon ➣ off  🔴\n"
                else:md+="❂͜͡☬➣ Autorespon ➣ off  🔴\n"
                if wait["detectMention3"] == True: md+="❂͜͡☬➣ Autorespon3 ➣ off  🔴\n"
                else:md+="❂͜͡☬➣ Autorespon3 ➣ off  🔴\n"             
                if wait["kickMention"] == True: md+="❂͜͡☬➣ Autokick ➣ on 🔵\n"
                else:md+="❂͜͡☬➣ Autokick ➣ off  🔴\n"
                if wait["Notifed"] == True: md+="❂͜͡☬➣ Notifed ➣ on 🔵\n"
                else:md+="❂͜͡☬➣ Notifed ➣ off  🔴\n"
                if wait["Notifedbot"] == True: md+="❂͜͡☬➣ Notifedbot ➣ on 🔵\n"
                else:md+="❂͜͡☬➣ Notifedbot ➣ off  🔴\n"
                if wait["acommentOn"] == True: md+="❂͜͡☬➣ Hhx1 ➣ on 🔵\n"
                else:md+="❂͜͡☬➣ Hhx1 ➣ off  🔴\n"
                if wait["bcommentOn"] == True: md+="❂͜͡☬➣ Hhx2 ➣ on 🔵\n"
                else:md+="❂͜͡☬➣ Hhx2 ➣ off  🔴\n"
                if wait["ccommentOn"] == True: md+="❂͜͡☬➣ Hhx3 ➣ on 🔵\n"
                else:md+="❂͜͡☬➣ Hhx3 ➣ off  🔴\n"
                if wait["Protectcancl"] == True: md+="❂͜͡☬➣ Cancel ➣ on 🔵\n"
                else:md+="❂͜͡☬➣ Cancel ➣ off  🔴\n"
                if wait["winvite"] == True: md+="❂͜͡☬➣ Invite ➣ on 🔵\n"
                else:md+="❂͜͡☬➣ Invite ➣ off  🔴\n"
                if wait["pname"] == True: md+="❂͜͡☬➣ Namelock ➣ on 🔵\n"
                else:md+="❂͜͡☬➣ Namelock ➣ off  🔴\n"
                ...
                if wait["autoCancel"]["on"] == True:md+="❂͜͡☬➣ Group cancel ➣" + str(wait["autoCancel"]["members"]) + "🔵\n"
                ...
                if wait["clock"] == True: md+="❂͜͡☬➣ Clock Name ➣ on 🔵\n"
                else:md+="❂͜͡☬➣ Clock Name ➣ off  🔴\n"
                ...
                if wait["qr"] == True: md+="❂͜͡☬➣ Protect QR ➣ on 🔵\n"
                else:md+="❂͜͡☬➣ Protect QR ➣ off  🔴\n"
                ...
                if wait["likeOn"] == True: md+="❂͜͡☬➣ ออโต้ไลค์ ➣ เปิด ✔\n"
                else:md+="❂͜͡☬➣ ออโต้ไลค์ ➣ ปิด  ❌\n"
                if wait["alwayRead"] == True: md+="❂͜͡☬➣ อ่านออโต้ ➣ เปิด ✔\n"
                else:md+="❂͜͡☬➣ อ่านออโต้ ➣ ปิด ❌\n"
                if wait["detectMention"] == True: md+="❂͜͡☬➣ การตอบรับ ➣ เปิด✔\n"
                else:md+="❂͜͡☬➣ การตอบรับ ➣ ปิด  ❌\n"
                if wait["detectMention3"] == True: md+="❂͜͡☬➣ การตอบรับ3 ➣ เปิด✔\n"
                else:md+="❂͜͡☬➣ การตอบรับ3 ➣ ปิด  ❌\n"
                if wait["kickMention"] == True: md+="❂͜͡☬➣ เตะออโต้ ➣ เปิด✔\n"
                else:md+="❂͜͡☬➣ เตะออโต้ ➣ ปิด  ❌\n"
                if wait["Notifed"] == True: md+="❂͜͡☬➣ แจ้งเตืิอนตนเอง ➣ เปิด ✔\n"
                else:md+="❂͜͡☬➣ แจ้งเตือนตนเอง ➣ ปิด  ❌\n"
                if wait["Notifedbot"] == True: md+="❂͜͡☬➣ แจ้งเตือนบอท ➣ เปิด ✔\n"
                else:md+="❂͜͡☬➣ แจ้งเตือนบอท ➣ ปิด  ❌\n"
                if wait["acommentOn"] == True: md+="❂͜͡☬➣ ข้อความคนเข้า ➣ เปิด✔\n"
                else:md+="❂͜͡☬➣ ข้อความคนเข้า ➣ ปิด  ❌\n"
                if wait["bcommentOn"] == True: md+="❂͜͡☬➣ ข้อความคนออก ➣ เปิด ✔\n"
                else:md+="❂͜͡☬➣ ข้อความคนออก ➣ ปิด  ❌\n"
                if wait["ccommentOn"] == True: md+="❂͜͡☬➣ ข้อความคนเตะกัน ➣ เปิด ✔\n"
                else:md+="❂͜͡☬➣ ข้อความคนเตะกัน ➣ ปิด  ❌\n"
                if wait["Protectcancl"] == True: md+="❂͜͡☬➣ ป้องกันการยกเลิกเชิญ ➣ เปิด ✔\n"
                else:md+="❂͜͡☬➣ ป้องกันการยกเลิกเชิญ ➣ ปิด  ❌\n"
                if wait["winvite"] == True: md+="❂͜͡☬➣ ป้องกันการเชิญ ➣ เปิด ✔\n"
                else:md+="❂͜͡☬➣ ป้องกันการเชิญ ➣ ปิด  ❌\n"
                if wait["pname"] == True: md+="❂͜͡☬➣ ล็อคชื่อ ➣ เปิด ✔\n"
                else:md+="❂͜͡☬➣ ล็อคชื่อ ➣ ปิด  ❌\n"
                if wait["contact"] == True: md+="❂͜͡☬➣ อ่านคท. ➣ เปิด ✔\n"
                else: md+="❂͜͡☬➣ อ่านคท. ➣ ปิด  ❌\n"
                if wait["autoJoin"] == True: md+="❂͜͡☬➣ เข้ากลุ่มอัตโนมัติ ➣ เปิด ✔\n"
                else: md +="❂͜͡☬➣ เข้ากลุ่มอัตโนมัติ ➣ ปิด  ❌\n"
                if wait["autoCancel"]["on"] == True:md+="❂͜͡☬➣ ยกเลิกการเชิญกลุ่มจำนวน ➣" + str(wait["autoCancel"]["members"]) + "✔\n"
                else: md+= "❂͜͡☬➣ ยกเลิกการเชิญกลุ่ม ➣ ปิด  ❌\n"
                if wait["leaveRoom"] == True: md+="❂͜͡☬➣ ป้องกันการดึงแชท ➣ เปิด ✔\n"
                else: md+="❂͜͡☬➣ ป้องกันการดึงแชท ➣ ปิด  ❌\n"
                if wait["timeline"] == True: md+="❂͜͡☬➣ แชร์อัตโนมัติ ➣ เปิด ✔\n"
                else:md+="❂͜͡☬➣ แชร์อัตโนมัติ ➣ ปิด  ❌\n"
                if wait["clock"] == True: md+="❂͜͡☬➣ ชื่อเวลา ➣ เปิด ✔\n"
                else:md+="❂͜͡☬➣ ชื่อเวลา ➣ ปิด  ❌\n"
                if wait["autoAdd"] == True: md+="❂͜͡☬➣ รับแอดอัตโนมัติ ➣ เปิด ✔\n"
                else:md+="❂͜͡☬➣ รับแอดอัตโนมัติ ➣ ปิด  ❌\n"
                if wait["commentOn"] == True: md+="❂͜͡☬➣ คอมเม้น ➣ เปิด ✔\n"
                else:md+="❂͜͡☬➣ คอมเม้น ➣ ปิด  ❌\n"
                if wait["Backup"] == True: md+="❂͜͡☬➣ การเชิญกลับ ➣ เปิด ✔\n"
                else:md+="❂͜͡☬➣ การเชิญกลับ ➣ ปิด  ❌\n"
                if wait["qr"] == True: md+="❂͜͡☬➣ ป้องกันลิ้ง ➣ เปิด ✔\n"
                else:md+="❂͜͡☬➣ ป้องกันลิ้ง ➣ ปิด  ❌\n〚•กราบขอบพระคุณที่ใช้บริการ•〛"
                cl.sendText(msg.to,md)
                msg.contentType = 13
                msg.contentMetadata = {'mid': admsa}
                cl.sendMessage(msg)
...
#========================================
                ...
                cl.sendText(msg.to,"╔═〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙═╗\n" + "•" + kata + "\n╚═〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙═╝")
...
#===============================================
                ...
                cl.sendText(msg.to, "🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ki1.sendText(msg.to, "🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ki2.sendText(msg.to, "🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ki3.sendText(msg.to, "🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ki4.sendText(msg.to, "🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ki5.sendText(msg.to, "🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ki6.sendText(msg.to, "🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ki7.sendText(msg.to, "🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ki8.sendText(msg.to, "🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ki9.sendText(msg.to, "🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ki10.sendText(msg.to, "🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))

                print "[Command]Speed palsu executed"

            elif msg.text in ["Keybot"]:
                ki.sendText(msg.to, "[BY:]\n┅═✥हई〚✯🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁✯〛ईह✥═┅\n❂͜͡☆➣ Namelock on\n❂͜͡☆➣ Namelock off\n❂͜͡☆➣ Blockinvite on\n❂͜͡☆➣ Blockinvite off\n❂͜͡☆➣ Backup on\n❂͜͡☆➣ Backup off\n\n[ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ]")
...
#=================================================
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                       ...
                       cl.sendText(g.mid,"〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙")
                       cl.sendText(g.mid,"〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙")
                       cl.sendText(g.mid,"〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙")
                       cl.sendText(g.mid,"〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙")
                       cl.sendText(g.mid,"〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙")
                       ki1.sendText(g.mid,"〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙")
                       ki1.sendText(g.mid,"〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙")
                       ki1.sendText(g.mid,"〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙")
                       ki1.sendText(g.mid,"〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙")
                       ki1.sendText(g.mid,"〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙")
                       ki2.sendText(g.mid,"〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙")
                       ki2.sendText(g.mid,"〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙")
                       ki2.sendText(g.mid,"〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙")
                       ki2.sendText(g.mid,"〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙")
                       ki2.sendText(g.mid,"〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙")
                       ki3.sendText(g.mid,"〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙")
                       ki3.sendText(g.mid,"〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙")
                       ki3.sendText(g.mid,"〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙")
                       ki3.sendText(g.mid,"〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙")
                       ki3.sendText(g.mid,"〘•🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁•〙")
       ...
       #-------------Fungsi Respon Start---------------------#
        ...
        if op.type == 26:
            ...
            if msg.contentType == 16:
                ...
                print ("Auto Like  BY ☞ 〚✯🍁✍Ð₱₭ ฿Ø₮₰ ⃟🇮🇩􏿿 ⃟🇮🇩􏿿 ⃟🇮🇩􏿿🍁✯〛")
